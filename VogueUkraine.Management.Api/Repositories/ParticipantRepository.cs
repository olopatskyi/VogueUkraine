...
public class ParticipantRepository : IParticipantRepository
{
    ...
    public Task<IAsyncCursor<ParticipantModel>> GetCursorAsync(int batchSize = 1000,
        CancellationToken cancellationToken = default)
    {
        var projection = Builders<Participant>.Projection
            .Expression(x => new ParticipantModel
            {
                Id = x.Id,
            });

        var findOptions = new FindOptions<Participant, ParticipantModel>
        {
        ...
        return _collection
            .FindAsync(Builders<Participant>.Filter.Empty, findOptions, cancellationToken);
    }
}